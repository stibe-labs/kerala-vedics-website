-- ======================================================
-- Kerala Vedics: Doctor Service Database Schema
-- Deploy: wrangler d1 execute kerala-vedics-doctors-db --file=schema.sql
-- ======================================================

-- Note: users table is owned by auth-service.
-- Doctor service holds a local copy of minimal user info
-- OR calls auth-service for user details.
